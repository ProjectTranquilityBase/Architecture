		...
		[
			...
			this.addEntry(dt + 'chevron list', function()
			{
				...
				var str1 = '&nbsp;- Lorem ipsum dolor sit amet<br>' +
			   	...
			   	var chrevron2 = new mxCell('LABEL', new mxGeometry(200, 0, 200, 30), 'shape=step;perimeter=stepPerimeter;whiteSpace=wrap;html=1;fixedSize=1;size=10;fillColor=#3B81F6;strokeColor=none;fontSize=17;fontColor=#FFFFFF;fontStyle=1;align=center;rounded=0;');
			...
			this.addEntry(dt + 'roadmap vertical', function()
		    {
		    	...
		    	var chevron2 = new mxCell('', new mxGeometry(0, 80, 70, 80), 'shape=step;perimeter=stepPerimeter;whiteSpace=wrap;html=1;fixedSize=1;size=10;direction=south;fillColor=#3B81F6;strokeColor=none;rounded=0;');
		    	chevron2.vertex = true;
		    	
			   	var label2 = new mxCell('<font style="font-size: 10px"><font style="font-size: 12px" color="#3B81F6"><b>Label</b></font><br><br><font size="1">' + 
			   			'Lorem ipsum dolor sit amet, consectetur adipisicing elit</font></font>', 
			...
			this.addEntry(dt + 'numbered list', function()
			{
			   	...
			   	var rect2 = new mxCell('Label', new mxGeometry(30, 75, 220, 40), 'shape=rect;rounded=1;whiteSpace=wrap;html=1;shadow=0;strokeColor=none;fillColor=#79A6F5;arcSize=30;fontSize=14;spacingLeft=42;fontStyle=1;fontColor=#FFFFFF;align=left;');
			   	rect2.vertex = true;
			   	var ellipse2 = new mxCell('2', new mxGeometry(0, 65, 60, 60), 'shape=ellipse;perimeter=ellipsePerimeter;fontSize=22;fontStyle=1;shadow=0;strokeColor=#ffffff;fillColor=#3B81F6;strokeWidth=4;fontColor=#ffffff;align=center;whiteSpace=wrap;html=1;');
			...
			this.addEntry(dt + 'list', function()
			{
				...
				var item1 = new mxCell('Label', new mxGeometry(0, 0, 80, 160), st1 + '10739E;');
			   	item1.vertex = true;
				var item2 = new mxCell('Label', new mxGeometry(85, 0, 80, 160), st1 + '040E1C;');
			   	item2.vertex = true;
			...
			this.addEntry(dt + 'rodmap horizontal', function()
			{
			   	...
			   	arch1.vertex = true;
			   	var arch2 = new mxCell('', new mxGeometry(105, 90, 120, 120), s4 + 'partConcEllipse;startAngle=0.75;endAngle=0.25;arcWidth=0.25;fillColor=#3B81F6;strokeColor=none;');
			   	arch2.vertex = true;
			   	...
			   	circle1.vertex = true;
			   	var circle2 = new mxCell('2', new mxGeometry(140, 125, 50, 50), 'shape=ellipse;strokeWidth=6;strokeColor=#3B81F6;fontSize=15;html=1;whiteSpace=wrap;fontStyle=1;fontColor=#3B81F6;');
			   	circle2.vertex = true;
			...
			this.addEntry(dt + 'roadmap diagonal', function()
			{
			   	...
			   	arch1.vertex = true;
			   	var arch2 = new mxCell('', new mxGeometry(190, 105, 120, 120), s4 + 'partConcEllipse;startAngle=0.25;endAngle=0;arcWidth=0.25;fillColor=#3B81F6;strokeColor=none;shadow=0;');
			   	arch2.vertex = true;
			   	...
			   	circle1.vertex = true;
			   	var circle2 = new mxCell('2', new mxGeometry(225, 140, 50, 50), 'shape=ellipse;strokeWidth=6;strokeColor=#3B81F6;fontSize=15;html=1;whiteSpace=wrap;fontStyle=1;fontColor=#3B81F6;shadow=1;');
			   	circle2.vertex = true;
			...
			this.addEntry(dt + 'arrow list', function()
			{
			   	...
			   	part2.vertex = true;
			   	var part3 = new mxCell('2', new mxGeometry(0, 45, 40, 40), 'html=1;whiteSpace=wrap;fillColor=#3B81F6;strokeColor=none;shadow=0;fontSize=17;fontColor=#FFFFFF;align=center;fontStyle=1;rounded=0;');
			   	part3.vertex = true;
			   	var part4 = new mxCell('Label', new mxGeometry(45, 45, 115, 40), 'shape=mxgraph.infographic.ribbonSimple;notch1=0;notch2=10;notch=0;html=1;whiteSpace=wrap;fillColor=#79A6F5;strokeColor=none;shadow=0;fontSize=17;fontColor=#FFFFFF;align=left;spacingLeft=10;fontStyle=1;');
			   	part4.vertex = true;
			...
			this.addEntry(dt + 'angled list', function()
			{
			   	...
			   	part2.vertex = true;
			   	var part3 = new mxCell('2', new mxGeometry(0, 35, 50, 30), 'shape=mxgraph.infographic.parallelogram;dx=5;html=1;whiteSpace=wrap;fillColor=#3B81F6;strokeColor=none;shadow=0;fontSize=17;fontColor=#FFFFFF;align=center;fontStyle=1;');
			   	part3.vertex = true;
			   	var part4 = new mxCell('Label', new mxGeometry(45, 35, 115, 30), 'shape=mxgraph.infographic.parallelogram;dx=5;html=1;whiteSpace=wrap;fillColor=#79A6F5;strokeColor=none;shadow=0;fontSize=17;fontColor=#FFFFFF;align=left;spacingLeft=10;fontStyle=1;');
			   	part4.vertex = true;
			...
			this.addEntry(dt + 'angled list', function()
			{
			   	...
			   	part2.vertex = true;
			   	var part3 = new mxCell('2', new mxGeometry(150, 35, 50, 30), 'shape=mxgraph.infographic.parallelogram;dx=5;html=1;whiteSpace=wrap;fillColor=#3B81F6;strokeColor=none;shadow=0;fontSize=17;fontColor=#FFFFFF;align=center;fontStyle=1;');
			   	part3.vertex = true;
			   	var part4 = new mxCell('Label', new mxGeometry(195, 35, 145, 30), 'shape=mxgraph.infographic.parallelogram;dx=5;html=1;whiteSpace=wrap;fillColor=#79A6F5;strokeColor=none;shadow=0;fontSize=17;fontColor=#FFFFFF;align=left;spacingLeft=10;fontStyle=1;');
			   	part4.vertex = true;
			...
			this.addEntry(dt + 'matrix', function()
			{
			   	...
			   	part1.vertex = true;
			   	var part2 = new mxCell('Lorem ipsum dolor sit amet, consectetur adipisicing elit', new mxGeometry(140, 35, 100, 100), 'html=1;fillColor=#3B81F6;strokeColor=none;shadow=0;fontSize=12;fontColor=#FFFFFF;align=center;fontStyle=0;whiteSpace=wrap;rounded=0;');
			   	part2.vertex = true;
			...
			this.addEntry(dt + 'matrix', function()
			{
			   	...
			   	part1.vertex = true;
			   	var part2 = new mxCell('Lorem ipsum dolor sit amet, consectetur adipisicing elit', new mxGeometry(140, 35, 100, 100), 'shape=mxgraph.basic.three_corner_round_rect;dx=18;html=1;fillColor=#3B81F6;strokeColor=none;shadow=0;fontSize=12;fontColor=#FFFFFF;align=center;fontStyle=0;whiteSpace=wrap;rounded=0;');
			   	part2.vertex = true;
			...
			this.addEntry(dt + 'matrix', function()
			{
			   	var part11 = new mxCell('Lorem ipsum dolor sit amet, consectetur adipisicing elit', new mxGeometry(35, 35, 100, 100), 'html=1;fillColor=#3B81F6;strokeColor=none;shadow=0;fontSize=12;fontColor=#FFFFFF;align=center;fontStyle=0;whiteSpace=wrap;rounded=0;');
			   	part11.vertex = true;
			   	...
			   	part12.vertex = true;
			   	var part13 = new mxCell('Lorem ipsum dolor sit amet, consectetur adipisicing elit', new mxGeometry(245, 35, 100, 100), 'html=1;fillColor=#79A6F5;strokeColor=none;shadow=0;fontSize=12;fontColor=#FFFFFF;align=center;fontStyle=0;whiteSpace=wrap;rounded=0;');
			   	part13.vertex = true;
			...
			{
			   	var part1 = new mxCell('', new mxGeometry(0, 0, 350, 350), 'ellipse;html=1;strokeWidth=4;fillColor=#3B81F6;strokeColor=#ffffff;shadow=0;fontSize=10;fontColor=#FFFFFF;align=center;fontStyle=0;whiteSpace=wrap;spacing=10;');
			   	part1.vertex = true;
			   	var part2 = new mxCell('', new mxGeometry(25, 25, 300, 300), 'ellipse;html=1;strokeWidth=4;fillColor=#79A6F5;strokeColor=#ffffff;shadow=0;fontSize=10;fontColor=#FFFFFF;align=center;fontStyle=0;whiteSpace=wrap;spacing=10;');
			   	part2.vertex = true;
			...
			this.addEntry(dt + 'target simple', function()
			{
			   	...
			   	part1.vertex = true;
			   	var part2 = new mxCell('', new mxGeometry(50, 50, 250, 250), 'ellipse;html=1;strokeWidth=4;fillColor=#3B81F6;strokeColor=#ffffff;shadow=0;fontSize=10;fontColor=#FFFFFF;align=center;fontStyle=0;whiteSpace=wrap;spacing=10;');
			   	part2.vertex = true;
			...
			this.addEntry(dt + 'onion', function()
			{
			   	...
			   	part1.vertex = true;
			   	var part2 = new mxCell('', new mxGeometry(25, 50, 300, 300), 'ellipse;html=1;strokeWidth=4;fillColor=#79A6F5;strokeColor=#ffffff;shadow=0;fontSize=10;fontColor=#FFFFFF;align=center;fontStyle=0;whiteSpace=wrap;spacing=10;');
			   	part2.vertex = true;
			...
			this.addEntry(dt + 'onion simple', function()
			{
			   	var part1 = new mxCell('', new mxGeometry(0, 0, 350, 350), 'ellipse;html=1;strokeWidth=4;fillColor=#10739E;strokeColor=#ffffff;shadow=0;fontSize=10;fontColor=#FFFFFF;align=center;fontStyle=0;whiteSpace=wrap;spacing=10;');
			   	part1.vertex = true;
			   	var part2 = new mxCell('', new mxGeometry(50, 100, 250, 250), 'ellipse;html=1;strokeWidth=4;fillColor=#3B81F6;strokeColor=#ffffff;shadow=0;fontSize=10;fontColor=#FFFFFF;align=center;fontStyle=0;whiteSpace=wrap;spacing=10;');
			   	part2.vertex = true;
			...
			{
			   	var part1 = new mxCell('', new mxGeometry(0, 0, 350, 350), 'triangle;direction=north;html=1;strokeWidth=4;fillColor=#3B81F6;strokeColor=#ffffff;shadow=0;fontSize=10;fontColor=#FFFFFF;align=center;fontStyle=0;whiteSpace=wrap;spacing=10;');
			   	part1.vertex = true;
			   	var part2 = new mxCell('', new mxGeometry(25, 0, 300, 300), 'triangle;direction=north;html=1;strokeWidth=4;fillColor=#79A6F5;strokeColor=#ffffff;shadow=0;fontSize=10;fontColor=#FFFFFF;align=center;fontStyle=0;whiteSpace=wrap;spacing=10;');
			   	part2.vertex = true;
			...
			this.addEntry(dt + 'triangle simple', function()
			{
			   	...
			   	part1.vertex = true;
			   	var part2 = new mxCell('', new mxGeometry(50, 0, 250, 250), 'triangle;direction=north;strokeWidth=4;html=1;fillColor=#3B81F6;strokeColor=#ffffff;shadow=0;fontSize=10;fontColor=#FFFFFF;align=center;fontStyle=0;whiteSpace=wrap;spacing=10;');
			   	part2.vertex = true;
			...
			this.addEntry(dt + 'percent percentage list', function()
			{
			   	...
			   	bg2.vertex = true;
			   	var bar2 = new mxCell('', new mxGeometry(70, 60, 225, 20), 'whiteSpace=wrap;html=1;fixedSize=1;size=10;fillColor=#3B81F6;strokeColor=none;shadow=0;');
			   	bar2.vertex = true;
			...
			this.addEntry(dt + 'percent percentage list', function()
			{
			   	...
			   	bg2.vertex = true;
			   	var bar2 = new mxCell('45%', new mxGeometry(0, 50, 180, 40), 'html=1;shape=mxgraph.infographic.ribbonSimple;notch1=0;notch2=20;fillColor=#3B81F6;strokeColor=none;align=left;verticalAlign=middle;fontColor=#ffffff;fontSize=18;spacingLeft=10;fontStyle=1;shadow=0;');
			   	bar2.vertex = true;
			...
			this.addEntry(dt + 'arc list', function()
			{
			   	...
			   	arc1.vertex = true;
			   	var arc2 = new mxCell('', new mxGeometry(20, 20, 220, 220), s4 + 'partConcEllipse;fillColor=#3B81F6;strokeColor=#ffffff;startAngle=0.91;endAngle=0.17;arcWidth=0.18;strokeWidth=3;');
			   	arc2.vertex = true;
			...
			this.addEntry(dt + 'arc list', function()
			{
			   	...
			   	var arc1 = new mxCell('', new mxGeometry(0, 0, 250, 250), s4 + 'arc;fillColor=none;strokeColor=#10739E;startAngle=0.75;endAngle=0.08;strokeWidth=0.56;');
			   	arc1.vertex = true;
			   	var arc2 = new mxCell('', new mxGeometry(20, 20, 210, 210), s4 + 'arc;fillColor=none;strokeColor=#3B81F6;startAngle=0.91;endAngle=0.17;strokeWidth=0.56;');
			   	arc2.vertex = true;
			   	var arc3 = new mxCell('', new mxGeometry(40, 40, 170, 170), s4 + 'arc;fillColor=none;strokeColor=#AE4132;startAngle=0.75;endAngle=0.11;strokeWidth=0.56;');
			   	arc3.vertex = true;
			   	var arc4 = new mxCell('', new mxGeometry(60, 60, 130, 130), s4 + 'arc;fillColor=none;strokeColor=#12AAB5;startAngle=0.02;endAngle=0.25;strokeWidth=0.56;');
			   	arc4.vertex = true;
			   	var arc5 = new mxCell('', new mxGeometry(80, 80, 90, 90), s4 + 'arc;fillColor=none;strokeColor=#CCCCCC;startAngle=0.75;endAngle=0.25;strokeWidth=0.56;');
			   	arc5.vertex = true;
			...
			this.addEntry(dt + 'triangle graph', function()
			{
			   	...
			   	part1.vertex = true;
			   	var part2 = new mxCell('Label', new mxGeometry(60, 10, 80, 130), 'verticalLabelPosition=middle;verticalAlign=bottom;html=1;whiteSpace=wrap;shape=mxgraph.infographic.shadedTriangle;fillColor=#3B81F6;strokeColor=none;fontSize=10;labelPosition=center;align=center;fontColor=#FFFFFF;fontStyle=1;shadow=0;');
			   	part2.vertex = true;
			...
			this.addEntry(dt + 'pyramid graph', function()
			{
			   	...
			   	part1.vertex = true;
			   	var part2 = new mxCell('Label', new mxGeometry(60, 10, 80, 130), 'verticalLabelPosition=bottom;verticalAlign=top;html=1;shape=mxgraph.infographic.shadedPyramid;fillColor=#3B81F6;strokeColor=none;fontSize=10;labelPosition=center;align=center;shadow=0;');
			   	part2.vertex = true;
			...
			this.addEntry(dt + 'change graph', function()
			{
			   	...
			   	var part2 = new mxCell('', new mxGeometry(35, 10, 30, 120), 'fillColor=#3B81F6;strokeColor=none;');
			   	part2.vertex = true;
			...
			{
			   	var part1 = new mxCell('', new mxGeometry(70, 0, 20, 95), 'html=1;shape=mxgraph.infographic.pyramidStep;fillColor=#3B81F6;strokeColor=none;shadow=0;');
			   	part1.vertex = true;
			   	var part2 = new mxCell('', new mxGeometry(60, 10, 40, 85), 'html=1;shape=mxgraph.infographic.pyramidStep;fillColor=#79A6F5;strokeColor=none;shadow=0;');
			   	part2.vertex = true;
			...
			this.addEntry(dt + 'circular dial list horizontal', function()
			{
			   	...
			   	var part3 = new mxCell('Label', new mxGeometry(110, 0, 100, 100), 'verticalLabelPosition=bottom;verticalAlign=top;html=1;shape=mxgraph.basic.donut;dx=10;strokeColor=none;fillColor=#79A6F5;fontSize=12;fontColor=#3B81F6;align=center;fontStyle=1;');
			   	part3.vertex = true;
			   	var part4 = new mxCell('40%', new mxGeometry(0, 0, 100, 100), 'verticalLabelPosition=middle;verticalAlign=middle;html=1;whiteSpace=wrap;shape=mxgraph.basic.partConcEllipse;startAngle=0;endAngle=0.4;arcWidth=0.2;strokeColor=none;fillColor=#3B81F6;fontSize=22;fontColor=#3B81F6;align=center;fontStyle=1');
			   	part4.vertex = true;
			   	part3.insert(part4);
			...
			this.addEntry(dt + 'circular dial list vertical', function()
			{
			   	...
			   	var part3 = new mxCell('Label', new mxGeometry(0, 110, 100, 100), 'labelPosition=right;spacingLeft=10;html=1;shape=mxgraph.basic.donut;dx=10;strokeColor=none;fillColor=#79A6F5;fontSize=12;fontColor=#3B81F6;align=left;fontStyle=1;');
			   	part3.vertex = true;
			   	var part4 = new mxCell('40%', new mxGeometry(0, 0, 100, 100), 'verticalLabelPosition=middle;verticalAlign=middle;html=1;whiteSpace=wrap;shape=mxgraph.basic.partConcEllipse;startAngle=0;endAngle=0.4;arcWidth=0.2;strokeColor=none;fillColor=#3B81F6;fontSize=22;fontColor=#3B81F6;align=center;fontStyle=1');
			   	part4.vertex = true;
			   	part3.insert(part4);
			...
			this.addEntry(dt + 'circular dial list horizontal', function()
			{
			   	...
			   	var label2 = new mxCell('Label', new mxGeometry(110, 0, 100, 30), 'verticalLabelPosition=middle;verticalAlign=middle;html=1;fillColor=none;strokeColor=none;fontSize=15;fontColor=#3B81F6;align=center;fontStyle=1;');
			   	label2.vertex = true;
			   	var part2 = new mxCell('40%', new mxGeometry(110, 30, 100, 100), 'verticalLabelPosition=middle;verticalAlign=middle;html=1;whiteSpace=wrap;shape=mxgraph.infographic.partConcEllipse;startAngle=0;endAngle=0.4;arcWidth=0.4;strokeColor=none;fillColor=#3B81F6;fontSize=22;fontColor=#3B81F6;align=center;fontStyle=1;');
			   	part2.vertex = true;
			...
			this.addEntry(dt + 'circular dial list vertical', function()
			{
			   	...
			   	var part2 = new mxCell('40%', new mxGeometry(0, 110, 100, 100), 'verticalLabelPosition=middle;verticalAlign=middle;html=1;whiteSpace=wrap;shape=mxgraph.infographic.partConcEllipse;startAngle=0;endAngle=0.4;arcWidth=0.4;strokeColor=none;fillColor=#3B81F6;fontSize=22;fontColor=#3B81F6;align=center;fontStyle=1;');
			   	part2.vertex = true;
			   	var label2 = new mxCell('<font style="font-size: 10px"><font style="font-size: 12px" color="#3B81F6"><b>Label</b></font><br><br><font size="1">' + 
			   			'Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</font></font>', 
			...
			this.addEntry(dt + 'bar graph', function()
			{
			   	...
			   	var part2 = new mxCell('Label', new mxGeometry(50, 0, 40, 100), s2 + 'shadedCube;isoAngle=15;fillColor=#3B81F6;strokeColor=none;fontStyle=1;fontColor=#3B81F6;fontSize=12;shadow=0;');
			   	part2.vertex = true;
			...
			this.addEntry(dt + 'bar graph', function()
			{
			   	...
			   	var part2 = new mxCell('Label', new mxGeometry(50, 20, 40, 100), s2 + 'shadedCube;isoAngle=15;fillColor=#3B81F6;strokeColor=none;fontStyle=1;fontColor=#3B81F6;fontSize=12;shadow=0;');
			   	part2.vertex = true;
			...
			this.addEntry(dt + 'bar graph', function()
			{
			   	...
			   	var part2 = new mxCell('', new mxGeometry(25, 6, 40, 100), s2 + 'shadedCube;isoAngle=15;fillColor=#3B81F6;strokeColor=none;shadow=0;');
			   	part2.vertex = true;
			...
			this.addEntry(dt + 'bar graph', function()
			{
			   	...
			   	var part2 = new mxCell('Label', new mxGeometry(50, 20, 40, 100), s2 + 'cylinder;isoAngle=15;fillColor=#3B81F6;strokeColor=none;fontStyle=1;fontColor=#3B81F6;fontSize=12;shadow=0;');
			   	part2.vertex = true;
			   	var bg2 = new mxCell('', new mxGeometry(50, 0, 40, 40), 'verticalLabelPosition=top;verticalAlign=bottom;html=1;shape=mxgraph.infographic.cylinder;isoAngle=15;fillColor=#CCCCCC;strokeColor=none;fontStyle=1;fontColor=#3B81F6;fontSize=12;shadow=0;align=left;opacity=70;');
			   	bg2.vertex = true;
			...
			this.addEntry(dt + 'folded banners', function()
			{
			   	...
			   	var part2 = new mxCell('Label', new mxGeometry(0, 60, 200, 100), 
			   		'html=1;shape=mxgraph.infographic.bannerHalfFold;dx=40;dx2=20;notch=15;fillColor=#3B81F6;strokeColor=none;align=left;verticalAlign=top;fontColor=#ffffff;fontSize=14;fontStyle=1;spacingLeft=25;spacingTop=5;');
			   	part2.vertex = true;
			...
			this.addEntry(dt + 'cylinder graph', function()
			{
			   	...
			   	var part2 = new mxCell('Label', new mxGeometry(0, 75, 100, 55), 'verticalLabelPosition=middle;verticalAlign=middle;html=1;shape=mxgraph.infographic.cylinder;fillColor=#3B81F6;strokeColor=none;shadow=0;align=left;labelPosition=right;spacingLeft=10;fontStyle=1;fontColor=#3B81F6;');
			   	part2.vertex = true;
			...
			this.addEntry(dt + 'cylinder graph', function()
			{
			   	...
			   	var part2 = new mxCell('Label', new mxGeometry(0, 65, 100, 55), 'verticalLabelPosition=middle;verticalAlign=middle;html=1;shape=mxgraph.infographic.cylinder;fillColor=#3B81F6;strokeColor=none;shadow=0;align=left;labelPosition=right;spacingLeft=10;fontStyle=1;fontColor=#3B81F6;');
			   	part2.vertex = true;
			...
			this.addEntry(dt + 'ribbon list', function()
			{
			   	...
			   	var ribbon2 = new mxCell('', new mxGeometry(0, 120, 500, 100), 'html=1;shape=mxgraph.infographic.ribbonSimple;notch1=20;notch2=0;fillColor=#3B81F6;strokeColor=none;shadow=1;');
			   	ribbon2.vertex = true;
			...
			this.addEntry(dt + 'bar graph', function()
			{
			   	...
			   	var part2 = new mxCell('Label', new mxGeometry(120, 0, 160, 70), 'html=1;whiteSpace=wrap;shape=mxgraph.infographic.barCallout;dx=80;dy=30;fillColor=#3B81F6;strokeColor=none;align=center;verticalAlign=top;fontColor=#ffffff;fontSize=14;fontStyle=1;shadow=0;spacingTop=5;');
			   	part2.vertex = true;
			   	var dial2 = new mxCell('16', new mxGeometry(180, 75, 40, 40), 'ellipse;whiteSpace=wrap;html=1;aspect=fixed;shadow=0;strokeColor=#3B81F6;strokeWidth=6;fontSize=16;align=center;fontStyle=1');
			   	dial2.vertex = true;
			...
			this.addEntry(dt + 'arrow graph', function()
			{
			   	...
			   	var part2 = new mxCell('Label', new mxGeometry(50, 0, 90, 200), 'html=1;shadow=0;dashed=0;align=center;verticalAlign=top;shape=mxgraph.arrows2.arrow;dy=0.4;dx=60;direction=north;notch=0;strokeColor=#FFFFFF;strokeWidth=6;fillColor=#3B81F6;fontSize=14;labelPosition=center;verticalLabelPosition=bottom;fontStyle=1');
			   	part2.vertex = true;
			...
			this.addEntry(dt + 'triangular diagram', function()
			{
			   	...
			   	part1.vertex = true;
			   	var part2 = new mxCell('Label', new mxGeometry(0, 180, 240, 180), 'triangle;whiteSpace=wrap;html=1;shadow=0;strokeColor=#FFFFFF;strokeWidth=6;fillColor=#3B81F6;fontSize=16;fontColor=#FFFFFF;align=center;direction=north;fontStyle=1');
			   	part2.vertex = true;
			...
			this.addEntry(dt + 'roll', function()
			{
			   	...
			   	part5.vertex = true;
			   	var part6 = new mxCell('', new mxGeometry(125, 125, 150, 150), 'ellipse;html=1;strokeWidth=4;fillColor=#79A6F5;strokeColor=none;shadow=0;fontSize=10;fontColor=#FFFFFF;align=center;fontStyle=0;whiteSpace=wrap;spacing=10;');
			   	part6.vertex = true;
			   	...
			   	ribbon1.vertex = true;
			   	var ribbon2 = new mxCell('Label', new mxGeometry(200, 250, 340, 25), 'html=1;shape=mxgraph.infographic.ribbonSimple;notch1=0;notch2=20;fillColor=#79A6F5;strokeColor=none;align=right;verticalAlign=middle;fontColor=#ffffff;fontSize=14;fontStyle=1;shadow=0;spacingRight=25;');
			   	ribbon2.vertex = true;
			...
			this.addEntry(dt + 'cylinder graph', function()
			{
			   	...
			   	part1.vertex = true;
			   	var part2 = new mxCell('', new mxGeometry(315, 180, 100, 25), 'verticalLabelPosition=middle;verticalAlign=middle;html=1;shape=mxgraph.infographic.cylinder;fillColor=#3B81F6;strokeColor=none;shadow=0;align=left;labelPosition=right;spacingLeft=10;fontStyle=1;fontColor=#3B81F6;');
			   	part2.vertex = true;
			   	...
			   	var callout1 = new mxCell('Label', new mxGeometry(175, 0, 130, 160), 'strokeWidth=0.5;shadow=0;dashed=0;align=center;html=1;shape=mxgraph.mockup.text.callout;linkText=;textSize=17;textColor=#666666;callDir=NW;callStyle=line;fontSize=17;fontColor=#10739E;align=left;verticalAlign=top;strokeColor=#666666;fillColor=#4D9900;flipV=0;fontStyle=1;');
			   	callout1.vertex = true;
			   	var callout2 = new mxCell('Label', new mxGeometry(175, 80, 130, 110), 'strokeWidth=0.5;shadow=0;dashed=0;align=center;html=1;shape=mxgraph.mockup.text.callout;linkText=;textSize=17;textColor=#666666;callDir=NW;callStyle=line;fontSize=17;fontColor=#3B81F6;align=left;verticalAlign=top;strokeColor=#666666;fillColor=#4D9900;flipV=0;fontStyle=1;');
			   	callout2.vertex = true;
			   	var callout3 = new mxCell('Label', new mxGeometry(175, 160, 130, 50), 'strokeWidth=0.5;shadow=0;dashed=0;align=center;html=1;shape=mxgraph.mockup.text.callout;linkText=;textSize=17;textColor=#666666;callDir=NW;callStyle=line;fontSize=17;fontColor=#AE4132;align=left;verticalAlign=top;strokeColor=#666666;fillColor=#4D9900;flipV=0;fontStyle=1;');
			   	callout3.vertex = true;
			   	var callout4 = new mxCell('Label', new mxGeometry(175, 230, 130, 50), 'strokeWidth=0.5;shadow=0;dashed=0;align=center;html=1;shape=mxgraph.mockup.text.callout;linkText=;textSize=17;textColor=#666666;callDir=SW;callStyle=line;fontSize=17;fontColor=#23445D;align=left;verticalAlign=bottom;strokeColor=#666666;fillColor=#4D9900;flipV=0;fontStyle=1;');
			   	callout4.vertex = true;
			   	var callout5 = new mxCell('Label', new mxGeometry(175, 250, 130, 120), 'strokeWidth=0.5;shadow=0;dashed=0;align=center;html=1;shape=mxgraph.mockup.text.callout;linkText=;textSize=17;textColor=#666666;callDir=SW;callStyle=line;fontSize=17;fontColor=#12AAB5;align=left;verticalAlign=bottom;strokeColor=#666666;fillColor=#4D9900;flipV=0;fontStyle=1;');
			...
			this.addEntry(dt + 'swirl', function()
			{
			   	...
			   	part1.vertex = true;
			   	var part2 = new mxCell('', new mxGeometry(0, 79, 230, 140), 'html=1;shadow=0;dashed=0;align=center;verticalAlign=middle;shape=mxgraph.arrows2.uTurnArrow;dy=22;arrowHead=70;dx2=35;strokeColor=#ffffff;fillColor=#3B81F6;fontSize=12;fontColor=#3333FF;flipV=1;strokeWidth=4;');
			   	part2.vertex = true;
			...
			this.addEntry(dt + 'swirl', function()
			{
			   	...
			   	part1.vertex = true;
			   	var part2 = new mxCell('Label', new mxGeometry(30, 15, 150, 15), 'shape=manualInput;whiteSpace=wrap;html=1;shadow=0;fillColor=#3B81F6;strokeColor=none;fontSize=12;fontColor=#FFFFFF;align=center;direction=north;flipV=1;rounded=0;');
			   	part2.vertex = true;
			   	...
			   	arc1.vertex = true;
			   	var arc2 = new mxCell('', new mxGeometry(129, 15, 100, 100), 'verticalLabelPosition=bottom;verticalAlign=top;html=1;shape=mxgraph.basic.partConcEllipse;fillColor=#3B81F6;strokeColor=none;startAngle=0;endAngle=0.5;arcWidth=0.3;shadow=0;fontSize=7;fontColor=#FFFFFF;align=left;');
			   	arc2.vertex = true;
			   	...
			   	arc4.vertex = true;
			   	var arc5 = new mxCell('', new mxGeometry(130, 100, 100, 100), 'verticalLabelPosition=bottom;verticalAlign=top;html=1;shape=mxgraph.basic.partConcEllipse;fillColor=#3B81F6;strokeColor=none;startAngle=0.5;endAngle=0.00001;arcWidth=0.3;shadow=0;fontSize=7;fontColor=#FFFFFF;align=left;');
			   	arc5.vertex = true;
			   	...
			   	part4.vertex = true;
			   	var part5 = new mxCell('', new mxGeometry(179, 185, 151, 15), 'shape=manualInput;whiteSpace=wrap;html=1;shadow=0;fillColor=#3B81F6;strokeColor=none;fontSize=12;fontColor=#FFFFFF;align=center;direction=north;flipH=1;rounded=0;');
			   	part5.vertex = true;
			   	...
			   	marker1.vertex = true;
			   	var marker2 = new mxCell('2', new mxGeometry(40, 60, 30, 30), 'ellipse;whiteSpace=wrap;html=1;aspect=fixed;shadow=0;strokeColor=none;fillColor=#3B81F6;fontSize=17;fontColor=#FFFFFF;align=center;fontStyle=1;rounded=0;');
			   	marker2.vertex = true;
			...
			this.addEntry(dt + 'roadmap vertical', function()
			{
		    	...
		    	endPoint.insertEdge(edge1, false);
			   	...
			   	item1.vertex = true;
			   	var item2 = new mxCell('', new mxGeometry(234, 100, 246, 60), 'verticalLabelPosition=middle;verticalAlign=middle;html=1;shape=mxgraph.infographic.circularCallout2;dy=15;strokeColor=#3B81F6;labelPosition=center;align=center;fontColor=#3B81F6;fontStyle=1;fontSize=24;shadow=0;direction=north;flipH=1;');
			   	item2.vertex = true;
			   	...
			   	label1.vertex = true;
			   	var label2 = new mxCell('Label', new mxGeometry(250, 85, 160, 30), 'fillColor=#3B81F6;strokecolor=none;rounded=1;fontColor=#FFFFFF;strokeColor=none;fontStyle=1;fontSize=14;whiteSpace=wrap;html=1;');
			   	label2.vertex = true;
			   	...
			   	label7.vertex = true;
			   	var label8 = new mxCell('<font style="font-size: 10px"><font style="font-size: 12px" color="#3B81F6"><b>Label</b></font><br><br><font size="1">' + 
			   			'Lorem ipsum dolor sit amet, consectetur adipisicing elit</font></font>', 
			...
			this.addEntry(dt + 'roadmap horizontal', function()
			{
			   	...
			   	part2.vertex = true;
			   	var part3 = new mxCell('Label', new mxGeometry(200, 80, 120, 50), 'shape=mxgraph.infographic.ribbonSimple;notch1=0;notch2=10;notch=0;html=1;fillColor=#3B81F6;strokeColor=none;shadow=0;fontSize=17;fontColor=#FFFFFF;align=left;spacingLeft=10;fontStyle=1;whiteSpace=wrap;');
			   	part3.vertex = true;
			...
			this.addEntry(dt + 'flower', function()
			{
			   	...
			   	part1.vertex = true;
			   	var part2 = new mxCell('Lorem ipsum dolor sit amet, consectetur adipisicing elit', new mxGeometry(160, 0, 150, 150), 'shape=mxgraph.basic.diag_round_rect;dx=37;html=1;fillColor=#3B81F6;strokeColor=none;shadow=0;fontSize=12;fontColor=#FFFFFF;align=center;fontStyle=0;whiteSpace=wrap;strokeWidth=8;');
			   	part2.vertex = true;
