      ...
      if (
        ...
        if (bootstrap != null) {
          ...
          if (
            ...
            "9c693e05e3598c1b18eae12d147a29aa"
          ) {
            console.log(
        ...
        if (main != null) {
          ...
          if (
            CryptoJS.MD5(content).toString() !=
            "69c25556b6237c57cdb7d017147af34b"
          ) {
            console.log(
  ...
  if (file != null) {
    ...
    if (
      ...
      var uploadToS3 = mxUtils.bind(this, function (presignedUrl, fileData) {
        ...
        xhr.setRequestHeader("Content-Type", fileData.type); // Set the content type to the file type
        xhr.onreadystatechange = function () {
          if (xhr.readyState == 4) {
            if (xhr.status >= 200 && xhr.status <= 299) {
...
App.prototype.updateHeader = function () {
  if (this.menubar != null) {
     ...
     */
    var right =
      Editor.currentTheme != "atlas" && urlParams["embed"] != "1" ? 30 : 10;
